...
class Serie{
    ...
    public static Serie readClass(String fileName){
        ...
        try {
            ...
            //set nome da sÃ©rie
            serie.setName(searchName(fileName));
    ...
    public static String[] leituraPubIn(){
        String[] linhas = new String[100];
            ...
            while(conferirFim(linhas[tam1]) == false){ /* LEITURA DO ARQUIVO ENQUANTO ESSE NÃƒO CHEGAR NO FIM */
            tam1++;
            linhas[tam1] = MyIO.readLine();
            }
            return linhas;
...
public static void main(String[] args)throws ParseException{
	...
	Arq.openWrite("613764_sequencial.txt");
